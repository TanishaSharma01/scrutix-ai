...
logger = logging.getLogger("scrutix-ai-telemetry")
# Example log output: "scrutix-ai-telemetry - INFO - Azure Monitor enabled"
...
def setup_telemetry():
    ...
    try:
        ...
        configure_azure_monitor(
            ...
            logger_name="scrutix-ai-tracer"   # Optional: custom tracer name
        )
        # 
...
With:
/audit endpoint averages 4.5 sec (Indexer takes 3.8 sec)
